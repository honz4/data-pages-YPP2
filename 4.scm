...
;čísel pomocí Euklidova algoritmu pro hledání NSD.
;Popis viz. [[cs>Euklidův_algoritmus]]. Řešení založte na rekurzi.
(define (euclid a b)
  (if (= b 0)
    a
...
;popis viz [[wp>Leibniz_formula_for_pi]]. Řešení založte na rekurzi.
#|
